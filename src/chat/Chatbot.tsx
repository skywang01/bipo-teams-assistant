...
const SUGGEST = {
  ee: ["我要打卡", "申请明天 19:00-21:00 OT", "请下周三年假一天", "报销昨天打车 68 元", "查上月工资单"],
  manager: ["有哪些待审批 OT", "看今天的出勤 daily", "有待审批的休假吗", "做个研发部 OT 大盘", "研发部谁 OT 最多"],
};
...
export function Chatbot() {
  ...
  const suggestions = SUGGEST[role];
